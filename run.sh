...
size=$1
nb_proc=$2
./run_measures.py --global_csv result.csv --nb_runs 1 --size ${size} --nb_proc ${nb_proc} --topo "2;16,32;1,16;1,1;8" --experiment HPL --running_power 5004882812.500 --hugepage /root/huge
